...
Template.wizardButtons.events({
  'click .wizard-back-button': function(e) {
    ...
    // HUGH: The above is the original line; I've added insertDoc to make
    // sure that when moving to a previous step, then back again, the initial
    // step form contents aren't wiped.
    this.previous(
      AutoForm.getFormValues(this.activeStep(false).formId).insertDoc
    );
  }
});
